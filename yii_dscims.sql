...
--
-- Host: localhost
-- Generation Time: Aug 02, 2013 at 07:30 AM
...
(1, 1, '2013-02-21 17:37:56', 'protected', 'admin', 'admin', 1, 1, 'webmaster@example.com', NULL, NULL, NULL),
(2, 2, '2013-02-21 17:37:56', 'protected', 'demo', 'demo', 1, 1, 'demo@example.com', NULL, NULL, NULL);
...
(1, 'tttttttttttt', 'Test', '', 'INT', 0, 0, 0, '', '', 'Field is require', '', '', 0, 1, '');
...
(1, 'admin', '44068d441beed7f32d58f08ad67eee44119e9757c5e2a1fc12cd405fe1424156ba056f938e3c946f0b6a0c53793f65376ed09df9f5cb33cd942d8f5edd6ccc4b', 'feGgqp6kcIJxN3cTMeBiDPpGRjjcN+sVa8U1wFxcQnHom/w3rVxSTw6IsNZUqH7AvgWAlhaD4Xn+i78MadyyZA==', '', 1361448476, 1375417190, 1375417258, 0, 1, 1, NULL, 'Instant'),
(2, 'demo', '406912ea4182a114b7f8f53b79d34b2d2f73b3ee95bda6c84463e667e2c07f0b841b42681e661fd1322cf3875d88dc972630a1731229d50588a2dbf50c378322', 'uQESYhmqp0jIGbgN/2lwIT0Nva9HcDdmrxkxKZRu/cZALxnsO7rNSm1ov4ZlTtlU1EvRcgBDYaFfv4kkl95fPQ==', '', 1361448476, 0, 0, 0, 0, 1, NULL, 'Instant');
...
CREATE TABLE IF NOT EXISTS `user_group` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_user_group_user1_idx` (`owner_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `user_group_message` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_user_group_message_user1_idx` (`author_id`),
  KEY `fk_user_group_message_user_group1_idx` (`group_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
--
ALTER TABLE `message`
  ADD CONSTRAINT `fk_message_user1` FOREIGN KEY (`from_user_id`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_message_user2` FOREIGN KEY (`to_user_id`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `user_group`
  ADD CONSTRAINT `fk_user_group_user1` FOREIGN KEY (`owner_id`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `user_group_message`
--
ALTER TABLE `user_group_message`
  ADD CONSTRAINT `fk_user_group_message_user1` FOREIGN KEY (`author_id`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_user_group_message_user_group1` FOREIGN KEY (`group_id`) REFERENCES `user_group` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
